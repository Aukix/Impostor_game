...
/**
 * Asettaa pelin, arpoo sanan ja jakaa roolit.
 */
function setupGame() {
    ...
    // Arvotaan aloittaja (1 ja pelaajamaara välillä)
...
/**
 * Siirtää näytön korttien katseluvaiheeseen.
 */
...
function showHandoffScreen() {
    ...
    // Palautetaan taustaväri hetken kuluttua
    setTimeout(() => {
...
function showRoleScreen() {
    ...
    if (pelaajanRooli.rooli === 'Impostori') {
        ...
        // Kansalainen näkee pelaajanumeronsa ja sanan
        rooliTeksti.innerHTML = `
...
/**
 * Siirtyy keskusteluvaiheeseen ja näyttää aloittajan.
 */
function goToGameTimePhase() {
    peliKontti.style.display = 'none';
    
    // Luodaan dynaamisesti keskustelun aloitusruutu
    ...
    // Lisätään event listener uudelleen dynaamiselle napille
